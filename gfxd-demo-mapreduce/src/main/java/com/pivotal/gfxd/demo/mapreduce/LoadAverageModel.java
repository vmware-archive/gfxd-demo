...
public class LoadAverageModel implements Writable {
    ...
    public LoadAverageModel(int house_id, int household_id, int plug_id, int weekday, int time_slice, double total_load, int event_count) {
    ...
    public void setHousehold_id(int idx, PreparedStatement ps) throws SQLException {
    ...
    public void setEvent_count(int idx, PreparedStatement ps) throws SQLException {
